...
public class Sift_Matching_Demo implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		...
		SiftMatcher sm = new SiftMatcher(fsA); //created with the first siftSet
		// match the second set of features:
		List<SiftMatch> matches = sm.matchDescriptors(fsB); //take second set and call matchDescriptors
